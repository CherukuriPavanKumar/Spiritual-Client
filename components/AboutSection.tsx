        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-xl)' }}>
            ...
            >
              ...
              >
                ఉ. 8:00 – ఉ. 11:00 : లింగ ఆవరణ అభిషేక పూజ
              </p>
              <p
                style={{
                  fontSize: 'clamp(1rem, 0.9rem + 0.5vw, 1.125rem)',
              ...
              >
                ...
                భక్తులు స్వయంగా ఈ లింగంతో అభిషేకం చేస్తూ,
            ...
            >
              ...
              >
                ఉ. 11:30 నుండి : సువాసిని ఆవరణ పూజ
              </h3>
              <p
                style={{
                  fontSize: 'clamp(1rem, 0.9rem + 0.5vw, 1.125rem)',
            ...
            >
              ...
              >
                మధ్యాహ్న కార్యక్రమాలు (మ. 2:00 – సా. 3:30)
              </h3>
              <p
                style={{
                  fontSize: 'clamp(1rem, 0.9rem + 0.5vw, 1.125rem)',
              ...
              >
                చండీ ఆవరణ కుంకుమార్చన & వారాహిమాత అష్టోత్తర శతనామ కుంకుమార్చన
              </p>
              <p
                style={{
                  fontSize: 'clamp(1rem, 0.9rem + 0.5vw, 1.125rem)',
            ...
            >
              ...
              >
                సహస్ర రుద్ర చండీ హోమం – రుద్ర హవనం – లక్ష దీపోత్సవం
              </p>
              <p
                style={{
                  fontSize: 'clamp(1rem, 0.9rem + 0.5vw, 1.125rem)',
              ...
              >
                ...
                ఎండు ఫలాలు, ఎండు మెత్తులు, సుగంధ ద్రవ్యాలు ఉంటాయి.
              </p>
              <p
                style={{
                  fontSize: 'clamp(1rem, 0.9rem + 0.5vw, 1.125rem)',
            ...
            >
              ...
              >
                ...
                ప్రత్యక్షంగా మరియు ఆన్‌లైన్ ద్వారా
                కోటి శివనామ జప ఫలం పొందగలరు.
              </p>
            </motion.div>
